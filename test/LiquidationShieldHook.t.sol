...
contract LiquidationShieldHookTest is Test, Deployers {
    ...
    bytes32 constant BORROW_SIG      = keccak256("Borrow(address,address,address,uint256,uint8,uint256,uint16)");
    bytes32 constant REPAY_SIG       = keccak256("Repay(address,address,address,uint256,bool)");
    bytes32 constant LIQUIDATION_SIG = keccak256("LiquidationCall(address,address,address,uint256,uint256,address,bool)");
    bytes32 constant HEALTH_CHECK_SIG = keccak256("HealthCheckRequested(address,uint256,address,uint256)");
    ...
    function test_Monitor_React_HealthCheckRequest() public {
        ...
        IReactive.LogRecord memory log = _buildLog(
            HEALTH_CHECK_SIG,
            bytes32(uint256(uint160(monUser))),
            bytes32(uint256(SEPOLIA_CHAIN_ID)),
            bytes32(uint256(uint160(mockLendingPool))),
    ...
    function test_Monitor_React_UnmonitoredUser() public {
        ...
        monitor.react(_buildLog(
            BORROW_SIG,
            bytes32(0),
            bytes32(uint256(uint160(unknown))),
            bytes32(0),
            abi.encode(uint256(1000e18))
        ));
