...
contract DeployLasna is Script {
    ...
    function run() external {
        ...
        HealthFactorMonitor monitor = new HealthFactorMonitor{value: 0.1 ether}(
            SEPOLIA_CHAIN_ID, // Callback destination chain
            callbackReceiver, // CallbackReceiver on Sepolia
            hookAddress,      // Hook Address on Sepolia
